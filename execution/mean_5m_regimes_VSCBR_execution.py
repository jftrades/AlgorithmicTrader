...
# Parameter laden
yaml_path = str(Path(__file__).resolve().parents[1] / "config" / "mean_5m_regimes_VSCBR.yaml")
...
for i, combination in enumerate(itertools.product(*values)):
    ...
    strategy_config = ImportableStrategyConfig(
        strategy_path="strategies.mean_5m_regimes_VSCBR_strategy:Mean5mregimesStrategy",
        config_path="strategies.mean_5m_regimes_VSCBR_strategy:Mean5mregimesStrategyConfig",
