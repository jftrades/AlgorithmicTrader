...
# Parameter laden
yaml_path = str(Path(__file__).resolve().parents[1] / "config" / "mean_kalman_2TFs_vwap_GARCH_VIX.yaml")
...
for i, combination in enumerate(itertools.product(*values)):
    ...
    strategy_config = ImportableStrategyConfig(
        strategy_path="strategies.mean_kalman_2TFs_vwap_GARCH_VIX_strategy:Meankalman2TFsvwapGARCHVIXStrategy",
        config_path="strategies.mean_kalman_2TFs_vwap_GARCH_VIX_strategy:Meankalman2TFsvwapGARCHVIXStrategyConfig",
