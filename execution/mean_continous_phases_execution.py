...
# Parameter laden
yaml_path = str(Path(__file__).resolve().parents[1] / "config" / "mean_continous_phases.yaml")
...
for i, combination in enumerate(itertools.product(*values)):
    ...
    strategy_config = ImportableStrategyConfig(
        strategy_path="strategies.mean_continous_phases_strategy:MeancontinousphasesStrategy",
        config_path="strategies.mean_continous_phases_strategy:MeancontinousphasesStrategyConfig",
