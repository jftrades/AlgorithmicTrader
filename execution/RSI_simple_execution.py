...
# Parameter laden
yaml_path = str(Path(__file__).resolve().parents[1] / "config" / "RSI_simple.yaml")
...
for i, combination in enumerate(itertools.product(*values)):
    ...
    strategy_config = ImportableStrategyConfig(
        strategy_path="strategies.RSI_simple_strategy:RSISimpleStrategy",
        config_path="strategies.RSI_simple_strategy:RSISimpleStrategyConfig",
