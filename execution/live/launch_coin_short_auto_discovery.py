    ...
    def _create_node(self, instruments):
        strategy_config = ImportableStrategyConfig(
            ...
            config={
                ...
                "log_growth_atr_risk": {"enabled": True, "atr_period": 50, "atr_multiple": 3.0, "risk_percent": 0.04},
                "exp_growth_atr_risk": {"enabled": False},
                "exp_fixed_trade_risk": {"enabled": False},
                "log_fixed_trade_risk": {"enabled": False},
                "use_aroon_simple_trend_system": {"enabled": True, "aroon_period": 70, "aroon_osc_short_threshold": -40},
                "exit_scale_binance_metrics": {"enabled": True, "rolling_window_bars_binance": 1250, "upper_percentile_threshold_binance": 95, "lower_percentile_threshold_binance": 5},
                ...
                "max_leverage": 1.0,
                "use_min_coin_filters": {"enabled": False},
                "btc_performance_risk_scaling": {"enabled": False},
                "sol_performance_risk_scaling": {"enabled": False},
            }
        )
